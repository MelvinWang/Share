 ...
 * 描述： 待收货订单信息ViewModel
 */
public class WaitReceiveProOrderInfoViewModel extends BaseRecyclerViewModel<BaseModel> implements RequestView<BaseModel> {
    ...
    public WaitReceiveProOrderInfoViewModel(Context context, MyRecyclerView mRecyclerView, LinearLayout mRoot) {
        super(context, mRoot);
