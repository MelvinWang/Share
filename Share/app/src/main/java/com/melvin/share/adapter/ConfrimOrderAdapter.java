 ...
 * 描述： 确认订单Adapter
 */
public class ConfrimOrderAdapter extends BaseAdapter<ConfrimOrderAdapter.BindingHolder> {
    private List<BaseModel> list;
    private Context context;

    public ConfrimOrderAdapter(Context context, List<BaseModel> list) {
        this.list = list;
    ...
    public class BindingHolder extends RecyclerView.ViewHolder {
        final ConfirmOrderItemBinding binding;

        public BindingHolder(ConfirmOrderItemBinding binding) {
