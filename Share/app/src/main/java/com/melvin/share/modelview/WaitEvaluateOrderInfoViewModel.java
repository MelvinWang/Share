 ...
 * 描述： 待评价订单信息ViewModel
 */
public class WaitEvaluateOrderInfoViewModel extends BaseRecyclerViewModel<BaseModel> implements RequestView<BaseModel> {
    ...
    public WaitEvaluateOrderInfoViewModel(Context context, MyRecyclerView mRecyclerView, LinearLayout mRoot) {
        super(context, mRoot);
